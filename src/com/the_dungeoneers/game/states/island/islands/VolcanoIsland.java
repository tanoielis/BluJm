...
public class VolcanoIsland extends Island {
    ...
    public void setNeighbours(IslandManager im) {
        levels.put(IslandManager.islands.get("SkullIsland"), new Level1(g, player, camera, IslandManager.islands.get("SkullIsland"), im));
        levels.put(IslandManager.islands.get("BurningIsland"), new Level2(g, player, camera, IslandManager.islands.get("BurningIsland"), im));
    }
}